...
;(function($) {
    ...
    $.scrambler = function(element, options) {
        ...
        var defaults = {
            effect : "charbychar", // 2 options - charbychar and typewriter
            ...
            reveal: 1000, // number of milliseconds to reveal the character
            total_iterations : 0,
            interval : -1
        }
        ...
        plugin.init = function() {
            ...
            if (
              plugin.settings.effect == "charbychar" || plugin.settings.effect == "typewriter"
            ) {
